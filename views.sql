...
CREATE VIEW cyclosm_amenities_point AS
    SELECT
          ...
          COALESCE( -- order is important here
            ...
            'shop_' ||  CASE WHEN shop IN ('bicycle', 'bakery', 'beverage', 'convenience', 'convenience;gas', 'doityourself', 'gas', 'greengrocer', 'kiosk', 'supermarket', 'pastry', 'sports') THEN shop ELSE NULL END,
